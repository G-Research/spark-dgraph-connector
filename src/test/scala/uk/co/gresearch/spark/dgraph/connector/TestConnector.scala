...
class TestConnector extends AnyFunSpec {
  ...
  describe("Connector") {
    ...
    Seq(
      (
        Uid(UnsignedLong.valueOf(0)),
        "0",
        "0x0",
        true,
        false,
        UnsignedLong.ONE,
        UnsignedLong.ZERO.minus(UnsignedLong.ONE)
      ),
      (
        Uid.apply(UnsignedLong.valueOf(1).asInstanceOf[Any]),
        "1",
        "0x1",
        true,
        false,
      ...
      (
        Uid(UnsignedLong.fromLongBits(8214320560726473464L)),
        "8214320560726473464",
        "0x71ff21075549faf8",
        false,
        true,
        UnsignedLong.valueOf(8214320560726473465L),
        UnsignedLong.valueOf(8214320560726473463L)
      ),
      (
        Uid(UnsignedLong.fromLongBits(-6346846686373277921L)),
        "-6346846686373277921",
        "0xa7eb7890d6db0f1f",
        false,
        true,
        UnsignedLong.fromLongBits(-6346846686373277920L),
        UnsignedLong.fromLongBits(-6346846686373277922L)
      ),
    ...
    Seq(
      ...
      (
        UidRange(Uid(8214320560726473464L), Uid(UnsignedLong.fromLongBits(-6346846686373277921L))),
        UnsignedLong.valueOf(3885576826609800231L)
      ),
      (
        UidRange(
          Uid(UnsignedLong.fromLongBits(-6346846686373277921L)),
          Uid(UnsignedLong.fromLongBits(-1877623327044447073L))
        ),
        UnsignedLong.valueOf(4469223359328830848L)
      ),
    ...
    it("should validate UidRange") {
      ...
      assertThrows[IllegalArgumentException] {
        UidRange(Uid(UnsignedLong.fromLongBits(-6346846686373277921L)), Uid(8214320560726473464L))
      }
      assertThrows[IllegalArgumentException] {
        UidRange(
          Uid(UnsignedLong.fromLongBits(-1877623327044447073L)),
