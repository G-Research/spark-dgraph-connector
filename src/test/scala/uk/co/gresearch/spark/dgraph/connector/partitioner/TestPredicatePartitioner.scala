  ...
  describe("PredicatePartitioner") {
    ...
    it("should partition with 1 predicates per partition") {
      ...
      assert(partitions.toSet === Set(
        ...
        Partition(Seq(Target("host5:9080"), Target("host4:9080")), Set(Predicate("pred4", "type4", "type4")), None, None, model),
    ...
    it("should partition with 2 predicates per partition") {
      ...
      assert(partitions.toSet === Set(
        ...
        Partition(Seq(Target("host4:9080"), Target("host5:9080")), Set(Predicate("pred5", "type5", "type5"), Predicate("pred4", "type4", "type4")), None, None, model),
    ...
    Seq(3, 4, 7).foreach(predsPerPart =>
      it(s"should partition with $predsPerPart predicates per partition") {
        ...
        assert(partitions === Seq(
          ...
          Partition(Seq(Target("host2:9080"), Target("host3:9080")), Set(Predicate("pred1", "type1", "type1"), Predicate("pred3", "type3", "type3"), Predicate("pred2", "type2", "type2")), None, None, model),
    ...
    it("should apply PredicateNameIsIn filter") {
      ...
      assert(partitions1 === Seq(Partition(Seq(Target("host2:9080"), Target("host3:9080")), Set(Predicate("pred3", "type3", "type3")), None, None, model)))
      ...
      assert(partitions2 === Seq(
        Partition(Seq(Target("host2:9080"), Target("host3:9080")), Set(Predicate("pred2", "type2", "type2"), Predicate("pred3", "type3", "type3")), None, None, model),
        Partition(Seq(Target("host4:9080"), Target("host5:9080")), Set(Predicate("pred4", "type4", "type4")), None, None, model)
      ))
    }
    ...
    it("should apply ObjectValueIsIn with PredicateNameIsIn filter") {
      ...
      assert(partitions1 === Seq(Partition(Seq(Target("host2:9080"), Target("host3:9080")), Set(Predicate("pred3", "type3", "type3")), None, Some(Map("pred3" -> Set("value"))), model)))
      ...
      assert(partitions2 === Seq(
        Partition(Seq(Target("host2:9080"), Target("host3:9080")), Set(Predicate("pred2", "type2", "type2"), Predicate("pred3", "type3", "type3")), None, Some(valuesGroup2), model),
        Partition(Seq(Target("host4:9080"), Target("host5:9080")), Set(Predicate("pred4", "type4", "type4")), None, Some(valuesGroup3), model)
      ))
    }
