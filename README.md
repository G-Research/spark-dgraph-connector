...
e.g. 0.6.0-2.4, 0.6.0-3.0 and  0.6.0-3.1, respectively.
...
```sbt
libraryDependencies += "uk.co.gresearch.spark" %% "spark-dgraph-connector" % "0.6.0-3.0"
```
...
```shell script
spark-shell --packages uk.co.gresearch.spark:spark-dgraph-connector_2.12:0.6.0-3.0
```
...
```shell script
pyspark --packages uk.co.gresearch.spark:spark-dgraph-connector_2.12:0.6.0-3.0
```
...
```shell script
spark-submit --packages uk.co.gresearch.spark:spark-dgraph-connector_2.12:0.6.0-3.0 [script.py]
```
