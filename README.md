...
```sbt
libraryDependencies += "uk.co.gresearch.spark" %% "spark-dgraph-connector" % "0.7.0-2.4"
```
...
```shell script
spark-shell --packages uk.co.gresearch.spark:spark-dgraph-connector_2.12:0.7.0-2.4
```
...
```shell script
pyspark --packages uk.co.gresearch.spark:spark-dgraph-connector_2.12:0.7.0-2.4
```
...
```shell script
spark-submit --packages uk.co.gresearch.spark:spark-dgraph-connector_2.12:0.7.0-2.4 [script.py]
```
