...
./set-version.sh 3.3.4 2.12.15; mvn clean deploy -Dsign; mvn nexus-staging:release
./set-version.sh 3.4.4 2.12.17; mvn clean deploy -Dsign; mvn nexus-staging:release
./set-version.sh 3.5.3 2.12.18; mvn clean deploy -Dsign; mvn nexus-staging:release
...
./set-version.sh 3.4.4 2.13.8; mvn clean deploy -Dsign; mvn nexus-staging:release
./set-version.sh 3.5.3 2.13.8; mvn clean deploy -Dsign; mvn nexus-staging:release
