...
./set-version.sh 3.2.4 2.12.15 && mvn clean deploy && ./test-release.sh || exit 1
./set-version.sh 3.3.2 2.12.15 && mvn clean deploy && ./test-release.sh || exit 1
./set-version.sh 3.4.0 2.12.17 && mvn clean deploy && ./test-release.sh || exit 1
