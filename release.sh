...
./set-version.sh 3.3.4 2.12.15; mvn clean deploy -Dsign; ./test-release.sh
./set-version.sh 3.4.4 2.12.17; mvn clean deploy -Dsign; ./test-release.sh
./set-version.sh 3.5.3 2.12.18; mvn clean deploy -Dsign; ./test-release.sh
...
./set-version.sh 3.0.3 2.12.10; mvn clean deploy -Dsign -DskipTests -Dmaven.test.skip=true; mvn nexus-staging:release
./set-version.sh 3.1.3 2.12.10; mvn clean deploy -Dsign -DskipTests -Dmaven.test.skip=true; mvn nexus-staging:release
./set-version.sh 3.2.4 2.12.15; mvn clean deploy -Dsign -DskipTests -Dmaven.test.skip=true; mvn nexus-staging:release
./set-version.sh 3.3.4 2.12.15; mvn clean deploy -Dsign -DskipTests -Dmaven.test.skip=true; mvn nexus-staging:release
./set-version.sh 3.4.4 2.12.17; mvn clean deploy -Dsign -DskipTests -Dmaven.test.skip=true; mvn nexus-staging:release
./set-version.sh 3.5.3 2.12.18; mvn clean deploy -Dsign -DskipTests -Dmaven.test.skip=true; mvn nexus-staging:release

./set-version.sh 3.2.4 2.13.5; mvn clean deploy -Dsign -DskipTests -Dmaven.test.skip=true; mvn nexus-staging:release
./set-version.sh 3.3.4 2.13.8; mvn clean deploy -Dsign -DskipTests -Dmaven.test.skip=true; mvn nexus-staging:release
./set-version.sh 3.4.4 2.13.8; mvn clean deploy -Dsign -DskipTests -Dmaven.test.skip=true; mvn nexus-staging:release
./set-version.sh 3.5.3 2.13.8; mvn clean deploy -Dsign -DskipTests -Dmaven.test.skip=true; mvn nexus-staging:release
